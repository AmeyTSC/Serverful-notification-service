...
import { SmsErrorLogSchema } from 'src/schemas/smserror_logs.schema';
import { SmsHitLogSchema } from 'src/schemas/smshit_log.schema';
...
import { SMS_TemplateSchema } from 'src/schemas/sms_template.schema';
